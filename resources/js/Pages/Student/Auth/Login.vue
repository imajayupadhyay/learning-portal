    ...
    <div class="min-h-screen bg-white flex items-center justify-center px-4">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-10">
                ...
                <h1 class="text-3xl font-bold text-black tracking-tight">LMS Student</h1>
            ...
            <form v-if="activeTab === 'login'" @submit.prevent="submitLogin" class="space-y-5">
                <div>
                    <label for="login-email" class="block text-sm font-medium text-black mb-2">Email</label>
                    <input
                        id="login-email"
                ...
                <div>
                    <label for="login-password" class="block text-sm font-medium text-black mb-2">Password</label>
                    <div class="relative">
                        <input
                            id="login-password"
            ...
            <form v-if="activeTab === 'register'" @submit.prevent="submitRegister" class="space-y-5">
                <div>
                    <label for="reg-name" class="block text-sm font-medium text-black mb-2">Full Name</label>
                    <input
                        id="reg-name"
                ...
                <div>
                    <label for="reg-email" class="block text-sm font-medium text-black mb-2">Email</label>
                    <input
                        id="reg-email"
                ...
                <div>
                    <label for="reg-password" class="block text-sm font-medium text-black mb-2">Password</label>
                    <div class="relative">
                        <input
                            id="reg-password"
                ...
                <div>
                    <label for="reg-password-confirm" class="block text-sm font-medium text-black mb-2">Confirm Password</label>
                    <input
            ...
            <p class="text-center text-neutral-400 text-xs mt-10">LMS &mdash; Learning Management System</p>
        </div>
    </div>
</template>
